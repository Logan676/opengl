...
public class TextureHelper {
    ...
    public static int loadCubeMap(Context context, int[] cubeResources) {
        ...
        glTexParameteri(GL_TEXTURE_CUBE_MAP, GLES10.GL_TEXTURE_MIN_FILTER, GLES10.GL_LINEAR);
        glTexParameteri(GL_TEXTURE_CUBE_MAP, GLES10.GL_TEXTURE_MAG_FILTER, GLES10.GL_LINEAR);
